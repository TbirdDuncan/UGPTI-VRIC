...
//import android.support.annotation.DrawableRes  //androidx.annotation DR below covers it.
//import android.support.v4.app.NotificationCompat  //androidx.core NC below probably covers it, though I had another option?
//import android.support.v4.app.TaskStackBuilder  //androidx.core TSB below probably covers it, though I had another option?
//import android.support.v4.content.ContextCompat  //androidx.core CC below covers it.
//import android.support.v4.content.res.ResourcesCompat  //androidx.core RC below covers it.
...
fun sendNotification(context: Context, message: String, latLng: LatLng) {
    ...
    val intent = MapFragment.newIntent(context.applicationContext, latLng)  //ui.map.MapFragment, then the error should ask to import com.example.nav.ui.map.MapFragment...the trick is to get MapFragment error free first.
